    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <Card className="border-0 shadow-md rounded-xl p-5 transition-all duration-200 hover:shadow-lg hover:-translate-y-0.5 group cursor-pointer">
          <Link href="/dashboard/applications" className="flex flex-col items-center gap-3 text-center">
            <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-blue-50 text-blue-600 transition-colors group-hover:bg-blue-100 dark:bg-blue-900/20 dark:text-blue-400 dark:group-hover:bg-blue-900/30">
              <FileText className="h-6 w-6" />
            </div>
            <div>
              <p className="text-sm font-semibold text-gray-900 dark:text-white">Review Applications</p>
              <p className="text-xs text-muted-foreground mt-0.5">{stats.pendingApplications} pending</p>
            </div>
          </Link>
        </Card>

        <Card className="border-0 shadow-md rounded-xl p-5 transition-all duration-200 hover:shadow-lg hover:-translate-y-0.5 group cursor-pointer">
          <Link href="/dashboard/interviews" className="flex flex-col items-center gap-3 text-center">
            <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-cyan-50 text-cyan-600 transition-colors group-hover:bg-cyan-100 dark:bg-cyan-900/20 dark:text-cyan-400 dark:group-hover:bg-cyan-900/30">
              <Calendar className="h-6 w-6" />
            </div>
            <div>
              <p className="text-sm font-semibold text-gray-900 dark:text-white">Manage Interviews</p>
              <p className="text-xs text-muted-foreground mt-0.5">{stats.scheduledInterviews} scheduled</p>
            </div>
          </Link>
        </Card>

        <Card className="border-0 shadow-md rounded-xl p-5 transition-all duration-200 hover:shadow-lg hover:-translate-y-0.5 group cursor-pointer">
          <Link href="/dashboard/student-assistants" className="flex flex-col items-center gap-3 text-center">
            <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-violet-50 text-violet-600 transition-colors group-hover:bg-violet-100 dark:bg-violet-900/20 dark:text-violet-400 dark:group-hover:bg-violet-900/30">
              <Users className="h-6 w-6" />
            </div>
            <div>
              <p className="text-sm font-semibold text-gray-900 dark:text-white">Student Assistants</p>
              <p className="text-xs text-muted-foreground mt-0.5">{stats.activeSAs} active</p>
            </div>
          </Link>
        </Card>

        <Card className="border-0 shadow-md rounded-xl p-5 transition-all duration-200 hover:shadow-lg hover:-translate-y-0.5 group cursor-pointer">
          <Link href="/dashboard/notifications" className="flex flex-col items-center gap-3 text-center">
            <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-amber-50 text-amber-600 transition-colors group-hover:bg-amber-100 dark:bg-amber-900/20 dark:text-amber-400 dark:group-hover:bg-amber-900/30">
              <Bell className="h-6 w-6" />
            </div>
            <div>
              <p className="text-sm font-semibold text-gray-900 dark:text-white">Notifications</p>
              <p className="text-xs text-muted-foreground mt-0.5">Stay updated</p>
            </div>
          </Link>
        </Card>
      </div>
