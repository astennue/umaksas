        ...
        <AnimatePresence>
          {open && (
            ...
            >
              ...
              <div className="relative bg-gradient-to-br from-blue-900 to-blue-800 px-6 pt-8 pb-10 text-center">
                {/* Decorative circles */}
                <div className="absolute top-4 right-4 w-20 h-20 rounded-full bg-amber-500/10 blur-xl" />
                <div className="absolute bottom-2 left-4 w-16 h-16 rounded-full bg-blue-400/10 blur-xl" />
