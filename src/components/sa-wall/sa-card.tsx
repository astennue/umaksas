      ...
      <div
        className={`h-1.5 ${
          sa.isOnDuty
            ...
            : "bg-gradient-to-r from-blue-700 via-blue-600 to-amber-500"
        }`}
      />
      ...
      <CardContent className="p-5 pt-6">
        ...
        <div className="flex flex-col items-center text-center">
          <div className="relative mb-3">
            <div className="h-20 w-20 rounded-full bg-gradient-to-br from-blue-700 to-blue-900 flex items-center justify-center text-white font-bold text-xl shadow-md ring-4 ring-blue-100 dark:ring-blue-900/50 group-hover:ring-amber-200 dark:group-hover:ring-amber-800/50 transition-all duration-300">
              {initials}
            </div>
        ...
        <div className="flex items-center justify-center gap-2 flex-wrap">
          ...
          {sa.semester && (
            <Badge
              variant="secondary"
              className="bg-amber-50 dark:bg-amber-900/30 text-amber-700 dark:text-amber-300 text-xs font-medium border border-amber-100 dark:border-amber-800/50"
            >
