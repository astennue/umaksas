...
export function PublicHeader() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 h-16 bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl border-b border-blue-100 dark:border-gray-700">
      <div className="mx-auto flex h-full max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
              ...
              <Link
                ...
                className={cn(
                  ...
                  isApplyDisabled
                    ...
                    : pathname === link.href
                      ? "text-blue-700 bg-blue-50 dark:text-amber-400 dark:bg-amber-400/10"
                      : "text-gray-600 hover:text-blue-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-amber-400"
                )}
              >
        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            ...
            className="text-gray-600 hover:bg-gray-100 hover:text-blue-700 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-amber-400"
          >
